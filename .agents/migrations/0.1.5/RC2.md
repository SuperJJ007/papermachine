...
- 文档与证据提交：`d07caf626a`。
- 本阶段新增（`7545be293d..d07caf626a`）：350 个文件，+3449/−1059。
...
除注明外，均在代码候选 `0888810bd4` 或最终提交 `d07caf626a` 上由本阶段实际执行。
...
当前增量以 rc.2 为基准度量：`fb2c4b9e69..d07caf626a` 为 1515 个文件、+132266/−2596（`--no-renames`）；代码候选 `0888810bd4` 上为 1508 个文件、+129876/−2596。以 rc.1 为基准会把 rc.2 自身的发版算作私有工作，两者相差 322 个文件。
