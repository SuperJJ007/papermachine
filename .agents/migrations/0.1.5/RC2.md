...
范围：把官方 `dsh-v0.1.5-rc.2`（`fb2c4b9e698e30edb738bca4cf0618587db7d203`）merge-forward 到审计基线 `0888810bd4c41e6b80495df8bbf1eb0c2de50865`。基线已包含 rc.1（合并提交 `d2409f7235` 的第二父），因此本次是 rc.1→rc.2 的增量合并，不是快进。
