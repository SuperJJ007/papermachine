...
范围：把官方 `dsh-v0.1.5-rc.2`（`fb2c4b9e698e30edb738bca4cf0618587db7d203`）merge-forward 到审计基线 `42727936501003d214001ef74013a511878c35ae`。基线已包含 rc.1（合并提交 `d2409f7235` 的第二父），因此本次是 rc.1→rc.2 的增量合并，不是快进。
...
- 文档与证据提交：`6b25641ff7`、`d3d67a46dc`、`aeafbed9c9`（交付 SHA）。
- 本阶段新增（`7545be293d..aeafbed9c9`）：350 个文件，+3449/−1059。
...
除注明外，均在代码候选 `0888810bd4` 或交付 SHA `aeafbed9c9` 上由本阶段实际执行。
...
当前增量以 rc.2 为基准度量：`fb2c4b9e69..aeafbed9c9` 为 1515 个文件、+132011/−2596（`--no-renames`）；代码候选 `0888810bd4` 上为 1508 个文件、+129876/−2596。以 rc.1 为基准会把 rc.2 自身的发版算作私有工作，两者相差 322 个文件。
