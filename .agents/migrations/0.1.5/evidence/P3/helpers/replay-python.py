...
for scenario in ['sdk-snapshot','sdk-restart','sdk-minimal','sdk-minimal-in-history']:
 cmd=['/opt/miniconda3/bin/python',str(r/'scripts/smoke-python-runtime.py'),'--scenario',scenario,'--exe',str(r/'dist-exe/deepseek-harness-sdk-runtime-macos-arm64')]
 with (e/(scenario+'-replay.log')).open('w') as log:
 ...
 (e/'python-replay-checks.json').write_text(json.dumps(checks,indent=2)+'\n')
