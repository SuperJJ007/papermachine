...
The Runtime selects the nearest run-origin version of the requested artifact and verifies its figure key. The stored version provenance identifies the exact source and committed operations. A newer unaddressable source cannot fall back to an older addressable figure merely because their names match.
...
This specifies saved-version rendering within the broader [live-figure editing design](../architecture/2026-08-28-science-live-figure-editing.md); element catalogs, model references, and viewer ownership remain independent decisions there. The [element-id collision decision](2026-08-28-chart-element-id-collision.md) remains applicable without supersession.
...
Related owners: [science-live-figure-editing](../architecture/2026-08-28-science-live-figure-editing.md); [project-artifact-store-schema-v2](../architecture/2026-09-01-project-artifact-store-schema-v2.md).
