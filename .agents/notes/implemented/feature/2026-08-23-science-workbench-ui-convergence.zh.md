...
本记录中 Trace 与 Outcome 的放置已由 [Science 轨迹与会话记录信息架构](2026-08-25-science-trajectory-and-transcript-ia.zh.md) 取代；其中的溯源摘要布局已由 [Science artifact 溯源与私有 Review](2026-08-26-science-artifact-provenance-review.zh.md) 取代。按主体分侧的时间线与强制浅色配色由[轨迹中的 Science 过程步骤](2026-08-30-science-trace-process-view.zh.md)部分取代。文件舞台、composer 选择、设置、内核状态与桌面 toggle 放置仍有独立理由。下文描述的浅色重置机制与测试属于被取代的配色决策。
