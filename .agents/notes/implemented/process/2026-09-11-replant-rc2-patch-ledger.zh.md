...
私有增量以分支所含的最新上游发行版为基准度量，既不以更早的发行版为基准，也不以人工挑选的提交对为基准。合并 rc.2 之后，上游基准是 `fb2c4b9e698e30edb738bca4cf0618587db7d203`，故增量为 `fb2c4b9e698e30edb738bca4cf0618587db7d203..d07caf626a1e5c8efa484e42cdd9797805072b98`——以 `--no-renames` 度量 1515 个改动文件、+132266/−2596。在文档提交之前的代码候选 `0888810bd4c41e6b80495df8bbf1eb0c2de50865` 上，同一度量是 1508 个文件、+129876/−2596。
