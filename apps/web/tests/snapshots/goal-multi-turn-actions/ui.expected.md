...
- button "Ran 5 code executions, Ran 1 other steps 6 steps":
  - img
  - text: Ran 5 code executions, Ran 1 other steps 6 steps
...
- button "Context injection goal":
  ...
  - img
  - text: Context injection goal
- button "Ran 3 code executions 3 steps":
  - img
  - text: Ran 3 code executions 3 steps
