...
One record per shipped PaperMachine desktop DMG version, named `<version>.md` after `apps/desktop/package.json`'s `version` field (for example [0.1.1-rc.3.md](0.1.1-rc.3.md), [0.1.1-rc.4.md](0.1.1-rc.4.md), [0.1.0.md](0.1.0.md), [0.1.1.md](0.1.1.md)). Each record carries exactly three sections, in order:
