...
每个已发布的 PaperMachine 桌面 DMG 版本对应一份记录,文件名为 `<version>.md`,取自 `apps/desktop/package.json` 的 `version` 字段(例如 [0.1.1-rc.3.md](0.1.1-rc.3.zh.md)、[0.1.1-rc.4.md](0.1.1-rc.4.zh.md)、[0.1.0.md](0.1.0.zh.md)、[0.1.1.md](0.1.1.zh.md))。每份记录固定包含三节,顺序如下:
