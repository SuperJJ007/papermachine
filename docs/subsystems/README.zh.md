...
| [attachment.md](attachment.zh.md) | 持久图片与文本标识与元数据、校验输入、经校验读取，以及 `AttachmentStore` seam |
...
| [science.md](science.zh.md) | 宿主本地 Science Runtime 操作、既有 Conda prefix 观测、私有 scratch，以及它们追加的 environment/run Session 事件 |
