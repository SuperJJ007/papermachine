...
| [`science/`](science/README.md) | Science domain: required-on-read Session events, host-local Runtime operations, strict replay, and the optional `science` session projection | Product — stable API |
