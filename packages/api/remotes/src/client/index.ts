...
import scienceEditsRemote from '@deepseek-ai/dsh-tool-science/remote'
...
export async function apply(ctx: Context): Promise<() => Promise<void>> {
  ...
  try {
    for (const contribution of [
      ...
      pluginInventoryRemote, messageFeedbackRemote, sessionReferencesRemote, scienceEditsRemote,
    ]) {
