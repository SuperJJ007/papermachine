...
export const PROFILE_TEMPLATES: Record<string, ProfileTemplate> = {
  ...
  science: {
    bundles: ['@deepseek-ai/dsh-base', '@deepseek-ai/dsh-web-app', '@deepseek-ai/dsh-science-app'],
    patchReload: 'startup',
  },
  'science-headless': {
    bundles: ['@deepseek-ai/dsh-base', '@deepseek-ai/dsh-headless', '@deepseek-ai/dsh-science-app'],
    patchReload: 'startup',
  },
  headless: {
