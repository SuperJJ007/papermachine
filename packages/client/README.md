...
| [`ui-science/`](ui-science/README.md) | Replays Science chart and Outcome Tool occurrences with authorized attachment previews, and hosts the Science settings card. |
