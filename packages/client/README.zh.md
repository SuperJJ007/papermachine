...
| [`ui-science/`](ui-science/README.zh.md) | 重放 Science chart 与 Outcome 工具 occurrence 并显示经授权的附件预览，持有 Science 设置卡片，并加入用于查看当前 Science 状态的文件 toggle（由 Config 决定是 session 级还是应用全局）与只读 Details 条目。 |
