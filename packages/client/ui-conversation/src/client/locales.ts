...
export const zh = {
  ...
  'row.failed': '失败',
  'row.stopped': '已停止',
  'group.category.run': '运行了 {count} 段代码',
  'group.category.read': '读取了 {count} 个文件',
  'group.category.search': '搜索了 {count} 次',
  'group.category.edit': '保存或编辑了 {count} 个文件',
  'group.category.skill': '加载了 {count} 个 Skill',
  'group.category.other': '执行了 {count} 项操作',
  'group.categorySeparator': '，',
  'group.steps': '{count} 步',
  'group.stepsFailed': '{count} 步 · {failed} 失败',
  'group.collapse': '收起工具组',
  'group.expand': '展开工具组',
  'queue.count': '{n} 条排队消息',
  'queue.edit': '编辑排队消息',
...
export const en = {
  ...
  'row.failed': 'Failed',
  'row.stopped': 'Stopped',
  'group.category.run': 'Ran {count} code executions',
  'group.category.read': 'Read {count} files',
  'group.category.search': 'Searched {count} times',
  'group.category.edit': 'Saved or edited {count} files',
  'group.category.skill': 'Loaded {count} skills',
  'group.category.other': 'Ran {count} other steps',
  'group.categorySeparator': ', ',
  'group.steps': '{count} steps',
  'group.stepsFailed': '{count} steps · {failed} failed',
  'group.collapse': 'Collapse tool group',
  'group.expand': 'Expand tool group',
