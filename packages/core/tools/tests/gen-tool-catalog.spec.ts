...
describe('gen-tool-catalog collectToolCatalog', () => {
  it('boots every shipped tool package and harvests its model-facing schemas', async () => {
    ...
    expect(names).toEqual([
      ...
      'cordis_undefine', 'create_goal', 'edit', 'exit_plan_mode', 'get_goal', 'get_science_state', 'glob', 'grep',
      'install_science_packages', 'interrupt_agent', 'interrupt_agent', 'job_kill', 'job_list', 'job_output',
      'list_agents', 'list_agents', 'list_subagent_models', 'lsp', 'present', 'pwsh', 'pwsh', 'ralph',
      'read', 'read_image', 'run_code', 'run_python', 'run_r', 'schedule_create', 'schedule_delete',
