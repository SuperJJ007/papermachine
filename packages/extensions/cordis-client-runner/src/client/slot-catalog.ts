...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-science ScienceComposerDock id \'science-targets\'',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-science ScienceLibraryAction id \'science-library\'',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-science ScienceTraceView id \'science\'',
  ...
  },
  {
    ...
    keyDomain: 'open: any string the owner dispatches (no compile-time key set), already taken: science-artifact, science-library',
    ...
    occupants: [
      'client-ui-science ScienceDetailsView key \'science-artifact\'',
      'client-ui-science ScienceLibrary key \'science-library\'',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'rightbar.session\' (client-ui-sidebar-right), so it exists while that entry is mounted',
    occupants: [
      'client-ui-science ScienceArtifactTitle key \'science-artifact\'',
      'client-ui-science ScienceLibraryTitle key \'science-library\'',
  ...
  },
  {
    ...
    source: 'packages/client/ui-sidebar-documentpreview/src/client/contract/document.ts:24',
  },
  {
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'rightbar.session\' (client-ui-sidebar-right), so it exists while that entry is mounted',
    occupants: [
      'client-ui-science ScienceArtifactMenu id \'science-library\'',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    keyDomain: 'open: any string the owner dispatches (no compile-time key set), already taken: annotate_artifact, ask_user_question, bash, cordis_define, cordis_run, cordis_stop, cordis_undefine, edit, glob, grep, present, publish_outcome, read, read_image, skill, todo_write, web_fetch, web_search, write',
    hookContext: '',
    slotInject: '',
    ...
    occupants: [
      ...
      'client-ui-science ScienceExecutionRow',
