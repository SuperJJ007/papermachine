...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-science ScienceKernelStatus id \'science-kernels\'',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    occupants: [
      'client-ui-science ScienceDetailsHeader',
    ],
    replaceRisk: 'none',
  ...
  {
    key: 'conversation.details.header.tabs',
    kind: 'keyed',
    scope: 'session',
    summary: 'Second-row tabs for the active Details view, keyed by its entry id.',
    doc: 'Second-row tabs for the active Details view, keyed by its entry id.',
    registerOptions: [
      {
        name: 'key',
        requirement: 'required',
    ...
    declaredBy: 'an entry in \'details\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
      'client-ui-science ScienceDetailsTabs',
    ],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'conversation.details.header.tabs\', () => ctx.slots.register(\n      { name: \'conversation.details.header.tabs\', key: \'<one key the owner dispatches>\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-brand-papermachine PaperMachineBrandMark',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  {
    key: 'conversation.input.accessory',
    kind: 'list',
    scope: 'session',
    summary: 'Structured context chips rendered above the main composer textarea.',
    doc: 'Structured context chips rendered above the main composer textarea.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
    ...
    declaredBy: 'an entry in \'conversation\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
      'client-ui-science ComposerChipsEntry id \'science-targets\'',
    ],
    replaceRisk: 'none',
  ...
  {
    key: 'conversation.page.utilities',
    kind: 'list',
    scope: 'root',
    summary: 'Page-level utilities that remain available with or without a Session.',
    doc: 'Page-level utilities that remain available with or without a Session.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
    ...
    declaredBy: 'an entry in \'conversation\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
      'client-ui-science ScienceGlobalToggle',
      'client-ui-science ScienceHeroAction',
    ],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'conversation.page.utilities\', () => ctx.slots.register(\n      { name: \'conversation.page.utilities\', id: \'my-entry\', order: 100, label: \'My entry\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
  ...
  },
  {
    ...
    source: 'packages/client/ui-conversation/src/client/contract/slots.ts:83',
  },
  {
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-trajectory TrajectoryShell id \'trajectory\'',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    kind: 'single',
    scope: 'root',
    summary: 'Root-scoped Files surface used before a Session is selected.',
    doc: 'Root-scoped Files surface used before a Session is selected.',
    registerOptions: [],
    ownerProps: [
    ...
    declaredBy: 'an entry in \'root\' (client-ui-layout), so it exists while that entry is mounted',
    occupants: [
      'client-ui-science ScienceEmptyDetails',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-brand-papermachine PaperMachineBrandName',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    kind: 'list',
    scope: 'root',
    summary: 'Product destination rows between New Session and the session browser.',
    doc: 'Product destination rows between New Session and the session browser.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
    ...
    declaredBy: 'an entry in \'sidebar\' (client-ui-sidebar), so it exists while that entry is mounted',
    occupants: [
      'client-ui-science ScienceDestinations id \'science\'',
    ],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'sidebar.destinations\', () => ctx.slots.register(\n      { name: \'sidebar.destinations\', id: \'my-entry\', order: 100, label: \'My entry\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
  ...
  },
  {
    ...
    occupants: [
      'client-ui-science ScienceAnnotationRow key \'annotate_artifact\'',
      'client-ui-science ScienceExecutionRow key \'run_python\'',
      'client-ui-science ScienceExecutionRow key \'run_r\'',
  ...
  },
  {
    ...
    kind: 'list',
    scope: 'session',
    summary: 'One selectable implementation inside the Trajectory conversation tab.',
    doc: 'One selectable implementation inside the Trajectory conversation tab.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
    ...
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'trajectory.view\', () => ctx.slots.register(\n      { name: \'trajectory.view\', id: \'my-entry\', order: 100, label: \'My entry\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-trajectory/src/client/trajectory-subviews.ts:9',
  },
]
/* jscpd:ignore-end */
