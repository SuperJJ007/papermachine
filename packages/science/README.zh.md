...
| [`tool-science/`](tool-science/README.zh.md) | 面向模型的 Consumer：首次使用 binding/context，以及 `get_science_state`、`run_python`、`run_r`、`annotate_artifact`。 | 注册到 `ctx.tools` / `ctx.systemPrompt` |
