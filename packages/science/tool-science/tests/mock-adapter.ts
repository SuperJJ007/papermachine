/**
 * Minimal scripted `LlmAdapter` for the real agent-loop composition test,
 * trimmed from `packages/core/agent-loop/tests/mock-adapter.ts`'s pattern.
 */
...
/** Scripted adapter: each model call consumes the next queued response and records the request. */
