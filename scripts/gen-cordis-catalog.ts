...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  trajectorySubviews: 'client-side interface-typed subview registry — packages/client/ui-trajectory/README.md owns the API',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  SessionAttachmentExtractorEventType: 'session.md',
  SessionAttachmentExtractorMap: 'session.md',
  ExtractableEvent: 'session.md',
  SessionId: 'core.md',
  ...
  TextAttachmentRef: 'attachment.md',
  SaveTextAttachment: 'attachment.md',
  StoredTextAttachment: 'attachment.md',
  ...
  ScienceArtifactNoteReceipt: 'science.md',
  ScienceArtifactNoteRemoveRequest: 'science.md',
  ...
  ScienceSaveArtifactAsReceipt: 'science.md',
  ScienceSaveArtifactAsRequest: 'science.md',
  SaveScienceArtifactAsRequest: 'science.md',
  ScienceStyleEditReceipt: 'science.md',
  ScienceStyleEditRequest: 'science.md',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  ProjectId: 'branded project identity is owned by packages/science/science-artifact-store/README.md',
  ArtifactId: 'branded artifact identity is owned by packages/science/science-artifact-store/README.md',
  VersionId: 'branded version identity is owned by packages/science/science-artifact-store/README.md',
  OpenedProject: 'project identity resolution result is owned by packages/science/science-artifact-store/README.md',
  ArtifactRecord: 'artifact row shape is owned by packages/science/science-artifact-store/README.md',
  VersionRecord: 'version row shape is owned by packages/science/science-artifact-store/README.md',
  CreateArtifactInput: 'artifact-creation input is owned by packages/science/science-artifact-store/README.md',
  AppendVersionInput: 'version-append input is owned by packages/science/science-artifact-store/README.md',
  AnnotateVersionInput: 'version-curation input is owned by packages/science/science-artifact-store/README.md',
  NoteId: 'branded note identity is owned by packages/science/science-artifact-store/README.md',
  ArtifactNoteRecord: 'user-note row shape is owned by packages/science/science-artifact-store/README.md',
  PutNoteInput: 'note-creation input is owned by packages/science/science-artifact-store/README.md',
  FigureStateRecord: 'live-figure-state row shape is owned by packages/science/science-artifact-store/README.md',
