...
/**
 * Walk observed parent links once per PID, excluding the root itself.
 * Process-table snapshots can contain cycles after Windows parent PID reuse.
 * @param root - the process whose descendants are requested.
