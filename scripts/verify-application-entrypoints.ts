...
const EXECUTABLE_SOURCE_ALLOWLIST = new Map<string, string>([
  ...
  ['packages/science/science-runtime/tests/fixtures/fake-kernel-driver.mjs', 'test-only kernel protocol peer'],
  ['packages/science/science-runtime/tests/fixtures/fake-kernel-driver-bad-ready.mjs', 'test-only kernel protocol peer'],
  ['packages/science/science-runtime/tests/fixtures/fake-kernel-driver-delayed-ready.mjs', 'test-only kernel protocol peer'],
  ['packages/science/science-runtime/tests/fixtures/fake-kernel-driver-no-ready.mjs', 'test-only kernel protocol peer'],
