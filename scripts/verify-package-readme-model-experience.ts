...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-brand-papermachine': { kind: 'none', reason: 'Browser-side presentation occupants; registers nothing model-facing.' },
  ...
  'packages/client/ui-science': { kind: 'none', reason: 'Browser-side Science Tool presentation layer; renders logged chart and Outcome calls without changing model context.' },
  ...
  'packages/session/session-attachment-index': { kind: 'none', reason: 'The registry authorizes attachment reads from already-logged Session events and registers nothing model-facing.' },
